...
<body>
  ...
  <div>
        <div class="table_responsivee" style="margin-top:200px;";>
  <div>
       <h2> Officers</h2>
   </div>
        <table>
        <tr>
            <th style="height:50px; background-color: #00bcd4"; colspan="15"; ><h2>View Users</h2></th>
        </tr>   
        <tr>
            <th> ID</th>
            <th> First name</th>
        ...
        <div>
        <div class="table_responsivee" style="margin-top:-50px ";>
  <div>
       <h2> Customers</h2>
   </div>
        <table>
        ...
        <?php
            ...
            <tr>
                ...
                <td class="action_btnn"><a href="manage_account.php?email=<?php echo $rows['email']; ?>"onclick="return confirm('are you sure you want to delete this item')" > <i class="fas fa-trash"></i></a></td>
