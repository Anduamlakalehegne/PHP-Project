...
<body>
    ...
    <div class="main-content">
        <header>
            ...
            <div class="media"style="font-size:22px;  color: #2f66dd; ">
        ...
        <span  style=" color: #2f66dd; font-size:30px; margin:30px 0px 10px 0px;" class="fa fa-user"></span>
            ...
            <h3  style=" color: #2f66dd; margin-top:10px; " class="d">Email Address:</h3>
            <h3  style=" color: #2f66dd; margin-top:10px;"><?php echo $rows['email'];?></h3>
