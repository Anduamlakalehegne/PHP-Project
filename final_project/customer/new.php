...
<body>
 ...
 <hr>
    ...
    <?php 
        ...
        $query1=mysqli_query($conn,"SELECT * from role where id='$id' ");
        ...
        if(isset($_POST["submit"])){
          ...
          age='$age', region='$region', zone='$zone', kebele='$kebele'  where customer_id='$id' ";
            mysqli_query($conn, $query5);

            $query1 = "UPDATE role SET username='$username', email='$email' where id='$id' ";
        ...
        <div class="container"style="margin-top:70px ">
            ...
            <form action="#" method="POST" autocomplete="off">
                ...
                <div class="gender-details">
                  ...
                  <div class="category" name="sex">
                    <label for="dot-1" name="sex">
                    <span class="dot one"></span>
                    <span class="gender">Male</span>
                  </label>
                  <label for="dot-2" name="sex">
                    <span class="dot two"></span>
                    <span class="gender">Female</span>
                  </label>
                  <label for="dot-3" name="sex">
