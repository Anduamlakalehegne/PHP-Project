...
if(isset($_POST["submit"])){
  ...
  if (mysqli_num_rows($res) > 0) {
    ...
    $query = "INSERT INTO regr_officer(first_name, last_name, username, email, pnumber, age, registration_date, region, zone, kebele, sex, admin_id) 
    VALUES ('$first_name','$last_name','$username','$email','$pnumber','$age','$date','$region','$zone','$kebele','$sex', $registerdby)";
    mysqli_query($conn, $query);
    if ($query) {
      $pass=md5($password);
      $insertInfo = "INSERT INTO role( username, email, password, role) VALUES ('$first_name','$email','$pass','officer')";
...
<body>
        ...
        <div class="container"style="margin-top:-100px ">
            <div class="title" >Officer Rigsteration Form </div>
