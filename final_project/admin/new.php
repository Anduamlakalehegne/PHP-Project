...
<body>
 ...
 <hr>
    ...
    <?php 
        ...
        $query=mysqli_query($conn,"SELECT * from reg_manager WHERE email='$email' ");
        ...
        if(isset($_POST["submit"])){
          ...
          $zone = $_POST["zone"];
          $kebele = $_POST["kebele"];
          $query5 = "UPDATE reg_manager SET first_name='$first_name', last_name='$last_name', username='$username', email='$email', pnumber='$pnumber',
