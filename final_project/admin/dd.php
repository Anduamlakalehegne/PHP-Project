...
<body>
    ...
    <div class="main-content">
        ...
        <h2 class=""style="font-size:22px;  color: #2f66dd; ">
            ...
            <div class="nan"style="font-size:22px;  color: #2f66dd; ">
        ...
        ?>
        <div class="cards-single"  style="margin-top:margin-top:00px">
        <div class="nandus">
        <div class="aa">
        <span class="fa fa-user"></span>
        
            <span><h5>Well Come</h5></span>
            <h2  style=" color: #2f66dd; "> <?php echo $rows['full_name'];?></h2>
            <h4  style=" color: #2f66dd; " class="d">Email Address:</h4>
            <h4  style=" color: #2f66dd; "><?php echo $rows['email'];?></h4>
            <h5 style=" color: #2f66dd; " ><p>Phone Number:</p><?php echo $rows['pnumber'];?></h5>
            ...
            <a onclick="return confirm('Are you sure you want to logout')" href="../logout.php" style=" font-size:15px;  display: flex; margin-top:19px"> <span  class="fa fa-sign-out" style="font-size:20px; margin-left:35px;"></span>  <span style="font-size:20px; margin-left:15px">Log Out</span></a>
