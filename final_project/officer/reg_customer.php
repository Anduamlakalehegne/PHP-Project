...
if(isset($_POST["submit"])){
  ...
  if (mysqli_num_rows($res) > 0) {
    ...
    if (mail($email, $subject, $message, $sender)) {
        ...
        $query = "INSERT INTO customer(TIN_No, first_name, last_name, username, email, pnumber, age, date, region, zone, kebele, sex, officer_id) 
        VALUES ('$tin_no','$first_name','$last_name','$username','$email','$pnumber','$age','$date','$region','$zone','$kebele','$sex', $registerdby)";
        mysqli_query($conn, $query);
        if ($query) {
          $pass=md5($password);
          $insertInfo = "INSERT INTO role( username, email, password, role) VALUES ('$first_name','$email','$pass','customer')";
...
<body>
        ...
        <div class="container"style="margin-top:250px ">
            <div class="title" >Customer Rigsteration Form </div>

            <div class="content">
            <form action="#" method="POST" name="usertable">
                <div class="user-details">
                  <div class="input-box">
                    <span class="details">Tin No</span>
                    <input type="text" name="tin_no" placeholder="Enter TIN number" >
                       <p id="first_name"></p>
                  </div>
                  <div class="input-box">
