...
<div class="table_responsive" style="margin-top:400px; margin-left:-30px ";>
<div>
       <h2> Vat declarations</h2>
        ...
        <?php
            ...
            $query="SELECT * FROM vat_declaration where officer_id = '".$_SESSION["officer_id"]."' ";
            ...
            <tr>
               ...
               <td> <a href='printtax.php?id=<?php echo $rows['id'] ?>' title="Print Tax"> <i class="fa fa-print"></i> </a> </td>
        ...
        <div class="table_responsive" style="margin-top:40px; margin-left:-30px ";>
<div>
       <h2> TOT declarations</h2>
        ...
        <?php
            $query="SELECT * FROM tot_declaration where officer_id = '".$_SESSION["officer_id"]."' ";
            $res= mysqli_query($conn,$query);
            while($rows=mysqli_fetch_assoc($res)){
        ...
        <div class="table_responsive" style="margin-top:50px; margin-left:-30px; margin-bottom:100px; ";>
<div>
